...
//         <>
//           <div className='container-filtered'>
//             <h1>{selectedCategory ? selectedCategory.toUpperCase() : 'Resultados de búsqueda'}</h1>
//             {(selectedCategory || searchQuery) && <Tag onClick={showAllCategories} className='color-tag' style={{ color: 'black' }} rounded>Mostrar todos</Tag>}
//           </div>
